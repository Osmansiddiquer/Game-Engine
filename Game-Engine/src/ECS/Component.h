...
#define DEFINE_COMPONENT(NAME, BASE, UNIQUE)                   \
  ...
  class ENGINE_API_DECLARE                                     \
      Engine::ComponentRegistry<class NAME, BASE, Unique> {    \
   protected:                                                  \
    static bool NAME##Registered;                              \
  };                                                           \
  class ENGINE_API_DECLARE NAME                                \
      : public BASE,                                           \
        public Engine::ComponentRegistry<NAME, BASE, UNIQUE> { \
   protected:                                                  \
...
#define DEFINE_COMPONENT_END(NAME, BASE)                                 \
  ...
  ;                                                                      \
  template <bool Unique>                                                 \
  bool Engine::ComponentRegistry<NAME, BASE, Unique>::NAME##Registered = \
...
struct ENGINE_API_DECLARE ComponentRegistry {};
